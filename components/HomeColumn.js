...
export default function HomeColumn({icon, title, text, skills, tools, middle}) {
    return (
        <div  className={'p-20 bg-white border rounded-lg -mt-10 text-center overflow-hidden transform transition duration-500 hover:scale-110 hover:z-10 scale-100 ' + ( middle ? 'lg:scale-110 z-10' : '')}>
