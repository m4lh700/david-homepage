...
<header className='w-full flex flex-row justify-between items-center border-b border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-700 sticky top-0 z-50 transition duration-300 shadow'>
    ...
    <div className="block lg:hidden">
        ...
        <svg className="fill-current h-5 w-5 dark:text-white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
        </button>
    </div>
    <div className={`${
            active ? '' : 'hidden'
